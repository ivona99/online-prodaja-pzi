        ...
        <div class="checkout">
            <div class="row">
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <a href="index.php" class="btn btn-block btn-info" style="background-color:#6d5454; border:none;">Dodaj proizvod</a>
                </div>
                <div class="col-md-8 order-md-1">
                    ...
                    <form method="post" action="cartAction.php">
                        ...
                        <input class="btn btn-success btn-lg btn-block" style="background-color:#6d5454; border:none;" type="submit" name="checkoutSubmit" value="Naruči">
                    </form>
                </div>
            </div>
        </div>
